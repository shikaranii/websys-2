...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo '<tr><th><a href="orders.php?status=pending">Pending (' . $pendingCount . ')</a></th>
                      <th><a href="orders.php?status=accepted">Accepted (' . $acceptedCount . ')</a></th>
                      <th><a href="orders.php?status=completed">Completed (' . $completedCount . ')</a></th>
                      <th><a href="orders.php?status=return/refund">Return/Refund (' . $returnRefundCount . ')</a></th></tr>';
                ...
                echo '<table id="myorders-table">';
                echo '<tr><th><a href="orders.php?status=pending">Pending (' . $pendingCount . ')</a></th><th><a href="orders.php?status=accepted">Accepted (' . $acceptedCount . ')</a></th><th><a href="orders.php?status=completed">Completed (' . $completedCount . ')</a></th><th><a href="orders.php?status=/refund">Return/Refund (' . $returnRefundCount . ')</a></th></tr>';
                echo '<tr><th>Product</th><th>Quantity</th><th>Description</th><th>Total</th><th>Date Ordered</th><th>Status</th></tr>';
                echo '<tr>';
                echo '<td><img src="' . $product['productimage'] . '" alt="' . $product['productname'] . '"></td>';
                echo '<td>' . $row['quantity'] . '</td>';
